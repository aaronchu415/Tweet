class Node:
  ...
  def __repr__(self):
    return f'<Node(key={self.key}, list_words={self.content})>'
...
class AutoCompleteTrie:
  ...
  def display(self):
    ...
    # Uses an inefficient queue temporarily
    queue = []
    ...
    while queue:
      ...
      print(f'char: {curr.char} list_words: {curr.list_words} \n')
